...
public class ListOfAdminBalanceTransactionsRecyclerViewAdapter extends RecyclerView.Adapter<ListOfAdminBalanceTransactionsRecyclerViewAdapter.ViewHolder> {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView commission_tv, sender_tv, receiver_tv, amount_tv, dateTime_tv, transactionID_tv, serialNumber_tv;
        CardView cardView;
        ...
        ViewHolder(View itemView) {
            ...
            serialNumber_tv = itemView.findViewById(R.id.td_serialNumberTextView);
